...
- **Improved:** vulnerability/VEX filters auto-enable when a scan has findings.
- **Added:** Trivy vulnerability scan sample.
...
- **Added:** interactive relationship graph for SPDX 3 SBOMs, color-coded by element type.
- **Added:** sample SBOMs for Linux, Windows, Yocto, Zephyr, Docker, Vue.js, Jenkins, Android, and Kubernetes.
